  ...
  cv::Mat &mat)
{
  ...
  for(size_t i = 0; i < N; ++i)
  {
    ...
    {
		p[0] = (desc[j] & (1 << 7) ? 1.0f : 0.0f);
		p[1] = (desc[j] & (1 << 6) ? 1.0f : 0.0f);
		p[2] = (desc[j] & (1 << 5) ? 1.0f : 0.0f);
		p[3] = (desc[j] & (1 << 4) ? 1.0f : 0.0f);
		p[4] = (desc[j] & (1 << 3) ? 1.0f : 0.0f);
		p[5] = (desc[j] & (1 << 2) ? 1.0f : 0.0f);
		p[6] = (desc[j] & (1 << 1) ? 1.0f : 0.0f);
		p[7] = (desc[j] & (1 << 0) ? 1.0f : 0.0f);
    }
  } 
}
