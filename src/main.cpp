...
void main()
{
	...
	AlgParams algParams;
	//Load 3D geometry
	cv::FileStorage fileGeometry("Geometry.yml", cv::FileStorage::READ);
	fileGeometry["Vertices"] >> algParams.mVertices;
	fileGeometry["Faces"] >> algParams.mFaces;
	fileGeometry.release();

	//VideoCapture cap("E:\\2016\\BENT\\Implementation\\Data\\Videos\\S5\\Phase 2 640x480\\Bent_0120_video\\20160120_112319\\20160120_112319_w_object.mp4");
	VideoCapture cap("20160115_140820_480.mp4"); 
	//VideoCapture cap("20160115_140702_480.mp4"); 
	//VideoCapture cap("20160115_140916_480.mp4"); 
	...
	for (;;)
	{
		...
		if (bFirst){	// Initialize the trackers
			...
			InitializeTracker(camParams, trackList, frame, mGrayNext, 9, 1);

			// Update the pose with more points
			estimateCamPose(trackList, camParams);

		
			InitializeTracker(camParams, trackList, frame, mGrayNext, 11, 2);
	...
	printf("Average runtime: %.2f", dTimeSum/nCnt - 1);
	cvWaitKey();
	//////////////////////////////////////////////////////////////////////////////////////////////////  
}
...
void estimateCamPose(vector<TrackPoint>& trackList, CameraParams& camParams){
	...
	//solvePnPRansac(worldPts, imagePts, camParams.mIntrinsicMatrix, camParams.mDistortionCoeffs, camParams.mR, camParams.mT);
...
void generateWorldPointsTest(vector<TrackPoint>& trackList){
	...
	//aPoint.worldPoint = (Point3f(0, 1645, 3027));
	aPoint.worldPoint = (Point3f(0, 1645, 3030));
	trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 995, 3030));
	aPoint.worldPoint = (Point3f(0, 995, 3035));
	trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 1000, 4003));
	...
	//aPoint.worldPoint = (Point3f(0, 1000, 1000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 1000, 2000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 2000, 1000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 2000, 2000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 2000, 3000));
	//trackList.push_back(aPoint);

	//aPoint.worldPoint = (Point3f(0, 1000, 0));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 2000, 0));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 2000, 4000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(1000, 1000, 0));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(1000, 2000, 0));
	//trackList.push_back(aPoint);

	//aPoint.worldPoint = (Point3f(0, 0, 1000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 0, 2000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 0, 3000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(0, 0, 4000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(1000, 0, 0));
	//trackList.push_back(aPoint);

	//aPoint.worldPoint = (Point3f(1000, 0, 1000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(1000, 0, 2000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(1000, 0, 3000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(1000, 0, 4000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(2000, 0, 1000));
	//trackList.push_back(aPoint);

	//aPoint.worldPoint = (Point3f(2000, 0, 2000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(2000, 0, 3000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(2000, 0, 4000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(3000, 0, 3000));
	//trackList.push_back(aPoint);
	//aPoint.worldPoint = (Point3f(3000, 0, 2000));
	//trackList.push_back(aPoint);
